...
# NOTE: w_i_fitted.npy + cov_w.npy are produced by the unified fit_ensemble_weights.py.
# Run submit_fit_weights.sh (MODEL_TYPE=kernels) before submitting LRT jobs.
