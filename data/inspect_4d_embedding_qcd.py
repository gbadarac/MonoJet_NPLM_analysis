...
embedding dims to inspect. Two datasets currently use it (select with --data-dir):
  ...
  - gaussian_physics_embedding_data: an 8D embedding with a LeCun transform +
...
def parse_args():
    ...
    p.add_argument("--data-dir", default="gaussian_physics_embedding_data",
                   help="folder of ZJetsToNuNu_*.npz (relative to data/, or absolute). "
                        "Default: gaussian_physics_embedding_data.")
