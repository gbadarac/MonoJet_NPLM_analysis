...
#SBATCH --output=/work/gbadarac/MonoJet_NPLM/MonoJet_NPLM_analysis/Uncertainty_Modeling/Train_Models/nflows/EstimationNFnflows_outputs/logs/launcher_output_%j.out
#SBATCH --error=/work/gbadarac/MonoJet_NPLM/MonoJet_NPLM_analysis/Uncertainty_Modeling/Train_Models/nflows/EstimationNFnflows_outputs/logs/launcher_error_%j.err
...
sbatch --job-name=NF_collect \
  ...
  --mem=4G \
  --partition=standard \
  --wrap="source /work/gbadarac/miniforge3/bin/activate && conda activate nf_env && export PYTHONPATH=/work/gbadarac/MonoJet_NPLM/MonoJet_NPLM_analysis/Uncertainty_Modeling:\$PYTHONPATH && python /work/gbadarac/MonoJet_NPLM/MonoJet_NPLM_analysis/Uncertainty_Modeling/Train_Models/nflows/EstimationNFnflows.py --outdir ${trial_dir} --collect_all --num_models ${model_seeds}"