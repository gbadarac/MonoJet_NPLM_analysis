...
training_file = os.path.join(output_dir, "reduced_target_training_set.npy")
coverage_file = os.path.join(output_dir, "reduced_target_coverage_check_set.npy")
...
train_set = bkg_coord_scaled[:100000]
coverage_check_set = bkg_coord_scaled[100000:]
