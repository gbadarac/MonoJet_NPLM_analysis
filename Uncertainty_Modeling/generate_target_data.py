...
training_file = os.path.join(output_dir, "unscaled_reduced_target_training_set.npy")
coverage_file = os.path.join(output_dir, "unscaled_reduced_target_coverage_check_set.npy")
