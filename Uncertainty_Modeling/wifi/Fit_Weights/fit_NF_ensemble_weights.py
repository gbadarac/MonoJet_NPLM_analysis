...
while attempt < max_attempts:
    ...
    #N_10000_seeds_60_4_16_128_45
    w_i_init_torch = torch.tensor([ 0.0174,  0.0074,  0.0313,  0.0224,  0.0356, -0.0086,  0.0519,  0.0085,
        -0.0164, -0.0086,  0.0199,  0.0127, -0.0041,  0.0437,  0.0221,  0.0060,
         0.0220, -0.0261,  0.0108, -0.0351,  0.0228,  0.0493,  0.0067,  0.0081,
         0.0358,  0.0382,  0.0101,  0.0057,  0.0160,  0.0202,  0.0216,  0.0249,
         0.0163,  0.0486,  0.0145,  0.0147,  0.0562,  0.0031, -0.0201,  0.0413,
         0.0228,  0.0385,  0.0075,  0.0337,  0.0034, -0.0046, -0.0009,  0.0330,
        -0.0002,  0.0098,  0.0390,  0.0313,  0.0483, -0.0005,  0.0434,  0.0066,
        -0.0229,  0.0703,  0.0195, -0.0251], dtype=torch.float64, requires_grad=True)
    #'''
    try:
