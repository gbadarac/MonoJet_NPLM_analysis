...
def run_aggr(n_aggreg, test_label, X_train, Y_train, weight, flk_config, seed, xlabels_list=[], yrange_dict=None, plot=False, verbose=False, savefig=False, output_path=''):
    '''                                                                                                                                                                                      
    type of signal: "NP0", "NP1", "NP2", "NP3"                                                                                                                                               
    output_path: directory (inside ./runs/) where to save results                                                                                                                       
    N_0: size of ref sample                                                                                                                                       
