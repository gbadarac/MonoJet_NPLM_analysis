...
#d=data
#r=reference
python -u /work/gbadarac/MonoJet_NPLM/MonoJet_NPLM_analysis/NPLM/NPLM-embedding/toy_ensemble.py -d 100000 -r 500000 -t 100 -c $CALIBRATION -M 2400 | tee $TEMP_LOG
